...
@section('title', 'Data Inflasi Kesehatan- BPS Kota Semarang')
@section('page-title', 'Data Inflasi Kesehatan')
@section('page-subtitle', 'Inflasi Kesehatan Kota Semarang per tahun dan bulan')
    ...
    <div class="col-12">
        <div class="card shadow">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="fas fa-briefcase me-2"></i>Data Inflasi Kesehatan</h5>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>{{ number_format($item->ihk_kesehatan ?? 0) }}</td>
                                <td>{{ number_format($item->inflasi_kesehatan ?? 0) }}</td>
                                <td>{{ number_format($item->andil_kesehatan ?? 0 ) }}</td>
...
<div class="modal fade" id="addInflasiSehat" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{ route('inflasisehat.tambah') }}" method="POST">
                @csrf
                ...
                <div class="modal-body bg-light">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" name="ihk_kesehatan" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Inflasi</label>
                            <input type="number" class="form-control" name="inflasi_kesehatan" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Andil</label>
                            <input type="number" class="form-control" name="andil_kesehatan" required>
                        </div>
                    </div>
                </div>
