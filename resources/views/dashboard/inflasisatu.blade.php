...
@section('title', 'Data Inflasi Makanan, Minuman dan Tembakau - BPS Kota Semarang')
@section('page-title', 'Data Inflasi Makanan, Minuman dan Tembakau')
@section('page-subtitle', 'Inflasi Makanan, Minuman dan Tembakau Kota Semarang per tahun dan bulan')
    ...
    <div class="col-12">
        <div class="card shadow">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-light btn-sm" data-bs-toggle="modal" data-bs-target="#addInflasiMakanan">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>{{ number_format($item->ihk ?? 0) }}</td>
                                <td>{{ number_format($item->inflasi ?? 0) }}</td>
                                <td>{{ number_format($item->andil ?? 0 ) }}</td>
...
<!-- Modal Tambah Data -->
<div class="modal fade" id="addInflasiMakanan" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{ route('inflasimakanan.tambah') }}" method="POST">
                @csrf
                ...
                <div class="modal-body bg-light">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" name="ihk" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Inflasi</label>
                            <input type="number" class="form-control" name="inflasi" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Andil</label>
                            <input type="number" class="form-control" name="andil" required>
                        </div>
                    </div>
                </div>
