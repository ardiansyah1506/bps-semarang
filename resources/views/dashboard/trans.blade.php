...
@section('title', 'Data Inflasi Transportasi - BPS Kota Semarang')
@section('page-title', 'Data Inflasi Transportasi')
@section('page-subtitle', 'Inflasi Transportasi Kota Semarang per tahun dan bulan')
    ...
    <div class="col-12">
        <div class="card shadow">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="fas fa-briefcase me-2"></i>Data Inflasi Transportasi</h5>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>{{ number_format($item->ihk_trans ?? 0) }}</td>
                                <td>{{ number_format($item->inflasi_trans ?? 0) }}</td>
                                <td>{{ number_format($item->andil_trans ?? 0 ) }}</td>
...
<div class="modal fade" id="addInflasiRT" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{ route('inflasitrans.tambah') }}" method="POST">
                @csrf
                ...
                <div class="modal-body bg-light">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" name="ihk_trans" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Inflasi</label>
                            <input type="number" class="form-control" name="inflasi_trans" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Andil</label>
                            <input type="number" class="form-control" name="andil_trans" required>
                        </div>
                    </div>
                </div>
